...
export default function PharmacistPersonalInfoSection({ pharmacist }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const pharmacistId = storedUser?.userId;

      const response = await fetch(API_ENDPOINTS.UPDATE_PHARMACIST_PROFILE(pharmacistId), {
        method: 'PUT',
